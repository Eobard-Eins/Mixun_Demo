package com.example.demo.apis.customer.model;
...
@Table(name = "customers")//⽤于指定数据库的表名，表示此实体对应的数据库⾥⾯的表名，⾮必填，默认表名和 entity 名字⼀样。
public class Customer {
    ...
    @Column(name = "customer_name")//定义该属性对应数据库中的列名
