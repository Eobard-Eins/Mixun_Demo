package com.example.demo.apis.product.model;
...
@Table(name = "products")//⽤于指定数据库的表名，表示此实体对应的数据库⾥⾯的表名，⾮必填，默认表名和 entity 名字⼀样。
public class Product {
    ...
    @Column(name = "product_name")//定义该属性对应数据库中的列名
    private  String productName;

    @Column(name="product_price")
    private double productPrice;

    @Column(name="product_specs")//规格
